...
namespace ProjectTDD.test
{
    public class PlayerScoreTest
    {
        ...
        [Fact]
        public void CalculateScore_Roll111556_returnsIntScore1100()
        {
            Mock<model.IHand> fake_hand_111556 = new Mock<model.IHand>();
            fake_hand_111556 = fake_hand_111556_setup(fake_hand_111556);
            model.IPlayer sutScore = new model.Player(fake_hand_111556.Object);
        ...
        [Fact]
        public void CalculateScore_Roll333666_returnsIntScore900()
        {
            Mock<model.IHand> fake_hand_333666 = new Mock<model.IHand>();
            fake_hand_333666 = fake_hand_333666_setup(fake_hand_333666);
            model.IPlayer sutScore = new model.Player(fake_hand_333666.Object);
        ...
        private Mock<model.IHand> fake_hand_222444_setup(Mock<model.IHand> a_mockHand)
        {
            a_mockHand.Setup(mock => mock.Roll()).Verifiable();
            a_mockHand.Setup(mock => mock.Show()).Returns(fake_rolled6dice_list222444());
            a_mockHand.Setup(mock => mock.ShowSaved()).Returns(fake_emptydice_list());
            return a_mockHand;
        }

        private List<model.Dice> fake_rolled6dice_list222444()
        {
            List<model.Dice> dicelist = new List<model.Dice>();
            ...
            Mock<model.Dice> fake_dice3 = new Mock<model.Dice>();
            fake_dice3.Setup(mock => mock.GetValue()).Returns(model.Dice.DiceValue.Two);
            fake_dice3.Setup(mock => mock.Dicenumber).Returns(model.Hand.Dices.Dice_3);
            ...
            Mock<model.Dice> fake_dice6 = new Mock<model.Dice>();
            fake_dice6.Setup(mock => mock.GetValue()).Returns(model.Dice.DiceValue.Four);
            fake_dice6.Setup(mock => mock.Dicenumber).Returns(model.Hand.Dices.Dice_6);
        ...
        private Mock<model.IHand> fake_hand_111556_setup(Mock<model.IHand> a_mockHand)
        {
            a_mockHand.Setup(mock => mock.Roll()).Verifiable();
            a_mockHand.Setup(mock => mock.Show()).Returns(fake_rolled6dice_list111556());
            a_mockHand.Setup(mock => mock.ShowSaved()).Returns(fake_emptydice_list());
            return a_mockHand;
        }

        private List<model.Dice> fake_rolled6dice_list111556()
        {
            List<model.Dice> dicelist = new List<model.Dice>();
        ...
        private Mock<model.IHand> fake_hand_333666_setup(Mock<model.IHand> a_mockHand)
        {
            a_mockHand.Setup(mock => mock.Roll()).Verifiable();
            a_mockHand.Setup(mock => mock.Show()).Returns(fake_rolled6dice_list333666());
            a_mockHand.Setup(mock => mock.ShowSaved()).Returns(fake_emptydice_list());
            return a_mockHand;
        }

        private List<model.Dice> fake_rolled6dice_list333666()
        {
            List<model.Dice> dicelist = new List<model.Dice>();
